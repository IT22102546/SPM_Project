        ...
        <div className="min-h-screen " style={{
            ...
            <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-20">
                ...
                <Link to ="/" className="text-5xl font-bold dark:text-white font-tangerine">
                    <span className="px-2 py-1 bg-gradient-to-r from-indigo-500 via purple-500 to-pink-500  text-white rounded-lg  size-10/12" >our</span>logo
                </Link>
                <p className="text-sm mt-5 font-cinzel text-black font-extrabold">SPM SE.WE</p>
            </div>
                {/* right */}
